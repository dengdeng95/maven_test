...
public class StudentController extends BaseController
{
    ...
    @RequestMapping(value="/save11",method = RequestMethod.POST,produces = "application/json; charset=utf-8")
    @ApiOperation(value = "保存", httpMethod = "POST", notes = "保存学生信息", response = BaseResultVo.class)
    @ResponseBody
